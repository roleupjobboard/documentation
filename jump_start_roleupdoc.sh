...
REPOSITORY="roleupjobboard/documentation"
GITHUB_DIR=${WDIR}/doc
...
step "Set variables for Github deployment"
# cf. https://v2.docusaurus.io/docs/deployment/
GIT_USER=gsempe
USE_SSH=true
CURRENT_BRANCH=src

step "Commands"
step "Run a local run server to debug"
echo -e "$ npm run start"
step "Deploy a new version"
echo -e "$ GIT_USER=gsempe USE_SSH=true CURRENT_BRANCH=src npm run deploy"
